...
public:
	...
	// copy constructor
	rtObjGroup(const rtObjGroup& src_objG);
	...
	float testIntersections(glm::vec3 eye, glm::vec3 dir, bvh_node* bvh_root);
	...
	// make object list public so that
	// scene object can construct bvh
	// with it
